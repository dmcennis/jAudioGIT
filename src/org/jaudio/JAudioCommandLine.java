...
public class JAudioCommandLine {
	...
	static final private ResourceBundle bundle = ResourceBundle.getBundle("Translations");

	private static final String usage = MessageFormat.format(bundle.getString("UsageCommandline"), System.getProperty("line.separator"), System.getProperty("line.separator"));
